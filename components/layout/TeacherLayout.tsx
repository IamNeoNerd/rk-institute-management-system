...
const navigation = [
  { name: 'Dashboard', href: '/teacher/dashboard', icon: BarChart3, color: 'from-blue-500 to-blue-600' },
  { name: 'My Students', href: '/teacher/students', icon: Users, color: 'from-green-500 to-green-600' },
  { name: 'My Courses', href: '/teacher/courses', icon: BookOpen, color: 'from-purple-500 to-purple-600' },
  { name: 'Academic Logs', href: '/teacher/academic-logs', icon: FileText, color: 'from-orange-500 to-orange-600' },
  { name: 'Assignments', href: '/teacher/assignments', icon: FileText, color: 'from-teal-500 to-teal-600' },
];
            ...
            <div className="relative flex w-full flex-col bg-white/95 backdrop-blur-md shadow-xl">
              ...
              <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                <div className="flex-shrink-0 flex items-center px-6 mb-8">
                  <div className="h-10 w-10 bg-gradient-to-br from-teal-600 to-blue-600 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                    <span className="text-lg font-bold text-white">RK</span>
                  </div>
                  <h1 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Teacher Portal</h1>
                </div>
        ...
        <div className="flex-1 flex flex-col min-h-0 bg-white/80 backdrop-blur-md border-r border-gray-200/50">
          <div className="flex-1 flex flex-col pt-8 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-6 mb-8">
              <div className="h-12 w-12 bg-gradient-to-br from-teal-600 to-blue-600 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
