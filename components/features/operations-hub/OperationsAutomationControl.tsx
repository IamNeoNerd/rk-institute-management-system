        ...
        <Card>
          ...
          <Grid cols={3} responsive={{ sm: 1, md: 2, lg: 3 }}>
            <Button
              ...
              fullWidth
            >
              {triggeringJob === 'monthly-billing' ? 'Generating Bills...' : 'Trigger Monthly Billing'}
            </Button>
            ...
            <Button
              ...
              fullWidth
            >
              {triggeringJob === 'fee-reminder-overdue' ? 'Sending Reminders...' : 'Send Overdue Reminders'}
            </Button>
            ...
            <Button
              ...
              fullWidth
            >
              {triggeringJob === 'report-monthly' ? 'Generating Report...' : 'Generate Monthly Report'}
            </Button>
          </Grid>
        </Card>
      )}
