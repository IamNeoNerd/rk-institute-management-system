...
import { Grid, Card, LoadingState } from '@/components/ui';
                  ...
                  >
                    <div className='flex items-center'>
                      <div
                        ...
                        style={{
                          backgroundColor:
                            popularTemplatesData.datasets[0].backgroundColor[
                              index
                            ]
                        }}
                      ></div>
                    ...
                    <div className='text-right'>
                      <div className='text-sm font-medium text-gray-900'>
                        {stats.totalReports > 0
                          ? Math.round(
                              (template.usageCount / stats.totalReports) * 100
                            )
                          : 0}
                        %
                      </div>
              ...
              <div className='pt-4 border-t border-gray-200'>
                <div className='grid grid-cols-2 gap-4 text-center'>
                  ...
                  <div>
                    <div className='text-sm font-medium text-gray-900'>
                      {Math.round(
                        stats.totalReports * (stats.successRate / 100)
                      )}
                    </div>
        ...
        <Card>
          <div className='p-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              ...
              <div className='text-center'>
                <div className='text-2xl font-bold text-indigo-600 mb-1'>
                  {Math.round((stats.storageUsed / stats.totalReports) * 100) /
                    100 || 0}
                </div>
      ...
      <Card className='bg-blue-50 border-blue-200'>
        <div className='p-6'>
          ...
          <div className='space-y-2 text-sm text-blue-800'>
            {storagePercentage > 80 && (
              <div>
                • Consider deleting old reports to free up storage space
              </div>
            )}
            {stats.successRate < 90 && (
              <div>
                • Check your internet connection if reports are failing to
                generate
              </div>
            )}
            {stats.reportsThisMonth === 0 && (
              <div>
                • Try generating your first report using the templates above
              </div>
            )}
            <div>
