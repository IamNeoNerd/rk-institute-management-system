    ...
    <div className='space-y-6'>
      ...
      <div>
        ...
        <p className='text-gray-600'>
          Generate comprehensive reports for academic, financial, and
              ...
              <div className='p-6'>
                ...
                <div className='flex items-start justify-between mb-4'>
                  <div className='flex items-center'>
                    ...
                    <div>
                      ...
                      <span
                        className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${getCategoryColor(template.category)}`}
                      >
                ...
                <div className='space-y-2 mb-4'>
                  ...
                  <div className='flex items-center text-sm text-gray-500'>
                    ...
                    <span>
                      {template.outputFormats.join(', ').toUpperCase()}
                    </span>
                  </div>
                  <div className='flex items-center text-sm text-gray-500'>
                    <span className='mr-2'>⚙️</span>
      ...
      {filteredTemplates.length > 0 && (
        <div className='bg-gray-50 rounded-lg p-4'>
          <div className='flex items-center justify-between text-sm text-gray-600'>
            ...
            <span>Available for {userRole} role</span>
          </div>
        </div>
      )}
    </div>
