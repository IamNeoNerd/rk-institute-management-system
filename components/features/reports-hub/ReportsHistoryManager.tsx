...
export default function ReportsHistoryManager({
  reports
          ...
          <div className='mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-left'>
            <div className='bg-gray-50 rounded-lg p-4'>
              ...
              <p className='text-xs text-gray-500'>
                Access all previously generated reports with search and filter
                capabilities
              </p>
            </div>
            ...
            <div className='bg-gray-50 rounded-lg p-4'>
              ...
              <p className='text-xs text-gray-500'>
                Compare performance across different time periods and identify
                trends
              </p>
            </div>
            ...
            <div className='bg-gray-50 rounded-lg p-4'>
              ...
              <p className='text-xs text-gray-500'>
                Organize and manage report archives with bulk download options
              </p>
            </div>
          </div>
          ...
          <div className='mt-8 space-y-4'>
            <div className='bg-blue-50 rounded-lg p-4 border border-blue-200'>
              ...
              <ul className='text-sm text-blue-700 space-y-1'>
                <li>
                  • Advanced search and filtering by date, type, and status
                </li>
