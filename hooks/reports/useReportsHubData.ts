...
import {
  ...
  ActiveTab,
  ReportType
} from '@/components/features/reports-hub/types';
...
export function useAutomationReports(activeTab: ActiveTab) {
  ...
  return {
    ...
    error,
    refetch,
    updateAutomationReports: (reports: AutomationReport[]) =>
      mutate({ reports })
  };
}
...
export function useReportGeneration() {
  ...
  const {
    ...
    loading,
    error
  } = useApiMutation<any, { reportType: ReportType }>(
