...
export default function FamilyFeesView({ selectedChild }: FamilyFeesViewProps) {
  ...
  const filteredAllocations = selectedChild === 'all' 
    ? feeAllocations 
    : feeAllocations.filter(allocation => 
        allocation.studentName.includes(selectedChild === 'student-1' ? 'Emma' : 'Liam')
      );
    ...
    <div className="space-y-8">
      ...
      {selectedChild === 'all' && (
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">💳 Current Month Fee Breakdown by Child</h3>
          <div className="space-y-4">
            <div className="bg-blue-50 rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-3">Emma Johnson (Grade 11)</h4>
            ...
            <div className="bg-green-50 rounded-lg p-4">
              <h4 className="font-medium text-gray-900 mb-3">Liam Johnson (Grade 9)</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
      ...
      {/* Fee History */}
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">📊 Fee History</h3>
            ...
            <div key={allocation.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
              <div className="flex-1">
                <div className="flex items-center space-x-3">
                  <span className="font-medium text-gray-900">{allocation.studentName}</span>
