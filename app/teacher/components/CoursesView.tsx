  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage your courses and view student enrollments</p>
      </div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getEnrollmentColor(enrollmentPercentage)}`}>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-medium">{course.subscriptions.length} / {course.capacity}</span>
                </div>
                ...
                {course.feeStructure && (
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="font-medium">₹{course.feeStructure.amount.toLocaleString()}/{course.feeStructure.billingCycle.toLowerCase()}</span>
                  </div>
                )}
              </div>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-gray-600">{selectedCourse.grade} • {selectedCourse.subscriptions.length} students enrolled</p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{selectedCourse.capacity} students</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Current Enrollment:</span>
                        <span className="font-medium">{selectedCourse.subscriptions.length} students</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Status:</span>
                        <span className={selectedCourse.isActive ? 'text-green-600' : 'text-red-600'}>
                      ...
                      {selectedCourse.feeStructure && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            ₹{selectedCourse.feeStructure.amount.toLocaleString()}/{selectedCourse.feeStructure.billingCycle.toLowerCase()}
                          </span>
                        </div>
                      )}
                    </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-3">Enrollment Statistics</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Enrollment Rate:</span>
                      <span className="text-lg font-bold text-gray-900">{getEnrollmentPercentage(selectedCourse)}%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div
                        className={`h-3 rounded-full transition-all ${
                          getEnrollmentPercentage(selectedCourse) >= 90 ? 'bg-red-500' :
                          getEnrollmentPercentage(selectedCourse) >= 70 ? 'bg-yellow-500' : 'bg-green-500'
                        }`}
                        style={{ width: `${getEnrollmentPercentage(selectedCourse)}%` }}
                      ></div>
                    </div>
              ...
              {/* Enrolled Students */}
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">Enrolled Students</h4>
                    ...
                    selectedCourse.subscriptions.map((subscription) => (
                      <div key={subscription.id} className="bg-gray-50 rounded-lg p-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <span className="font-medium text-gray-900">{subscription.student.name}</span>
                              <span className="text-xs text-gray-500">{subscription.student.studentId}</span>
                            </div>
