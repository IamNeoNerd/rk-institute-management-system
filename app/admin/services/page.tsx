    ...
    <AdminLayout>
      <div className="space-y-8">
        <div className="flex justify-between items-center animate-fade-in">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Services</h1>
                  ...
                  <tr key={service.id}>
                    ...
                    <td className="table-cell">
                      {service.feeStructure ? (
                        <div>
                          <div className="font-medium">₹{service.feeStructure.amount}</div>
                          <div className="text-sm text-gray-500">{service.feeStructure.billingCycle}</div>
                        </div>
                      ) : (
