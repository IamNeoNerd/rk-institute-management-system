...
export default function AcademicLogDetail() {
  ...
  const fetchLog = async () => {
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to fetch academic log');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <AdminLayout>
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Academic Log Not Found</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-1">
                  <h1 className="text-2xl font-bold text-gray-900 mb-2">{log.title}</h1>
                ...
                <div className="flex flex-col space-y-2">
                  <span className={`inline-flex px-3 py-1 text-sm font-semibold rounded-full border ${getLogTypeColor(log.logType)}`}>
                    {log.logType}
                  </span>
                  {log.isPrivate && (
              ...
              <div className="prose max-w-none">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Log Content</h3>
