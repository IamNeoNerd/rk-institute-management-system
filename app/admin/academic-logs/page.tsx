    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Academic Logs Management</h1>
            <p className="mt-2 text-gray-600">
              Comprehensive oversight of all academic activities and student progress
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Private Logs</p>
                <p className="text-2xl font-semibold text-gray-900">
                  {logs.filter(log => log.isPrivate).length}
                </p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <tr key={log.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        ...
                        {log.subject && (
                          <div className="text-xs text-blue-600 mt-1">Subject: {log.subject}</div>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-medium text-gray-900">{log.student.name}</div>
                      {log.student.grade && (
                        <div className="text-sm text-gray-500">{log.student.grade}</div>
                      )}
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-medium text-gray-900">{log.teacher.name}</div>
                      <div className="text-sm text-gray-500">{log.teacher.email}</div>
                    </td>
                    <td className="px-6 py-4">
          ...
          {filteredLogs.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">No academic logs found</h3>
